...
FORMS += ..\oPB\ui\jobcreatortree.ui
FORMS += ..\oPB\ui\joblist.ui
FORMS += ..\oPB\ui\log.ui
FORMS += ..\oPB\ui\mainwindow.ui
FORMS += ..\oPB\ui\quickuninstall.ui
FORMS += ..\oPB\ui\lockedproducts.ui
FORMS += ..\oPB\ui\reportselector.ui
...
SOURCES += ..\oPB\controller\components\lockedproducts.py
...
SOURCES += ..\oPB\gui\lockedproducts.py
SOURCES += ..\oPB\gui\report.py
