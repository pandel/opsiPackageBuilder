...
# -*- coding: utf-8 -*-
#
# opsi PackageBuilder documentation build configuration file, created by
...
project = 'opsi PackageBuilder'
copyright = '2013-2016, Holger Pandel'
...
exclude_patterns = ['setup.py', 'ez_setup.py']
...
# document classes and their contructors
